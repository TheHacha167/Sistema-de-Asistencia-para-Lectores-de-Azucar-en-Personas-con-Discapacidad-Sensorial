Este directorio contiene los archivos de cabecera (header files) del proyecto. A continuación se describe el propósito de cada archivo y cómo configurar `secrets.h`.
